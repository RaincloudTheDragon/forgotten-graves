 ...
 * This allows compilation with both 1.20.5+ and pre-1.20.5 code
 */
public class FabricRecipeProvider implements DataProvider {
    protected final FabricDataOutput output;
    
    /**
     * Constructor for 1.20.5+ where registry lookup is not required
     */
    ...
    /**
     * Constructor for pre-1.20.5 where registry lookup is required
     */
